  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          const Center(child: Text("Create an account", style: TextStyle(fontSize: 30),)),
          ...
          ElevatedButton(onPressed: () => createAccount(emailController.text, passwordController.text), child: const Text("Create")),
        ],
      ),
    );
  }
